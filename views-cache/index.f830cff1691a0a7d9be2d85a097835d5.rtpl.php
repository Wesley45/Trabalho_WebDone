<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="slider-area">
            ...
            <div class="block-slider block-slider4">
                <ul class="" id="bxslider-home4">
                    <li>
                        <img src="/res/site/img/banner04.jpg" alt="Slide">
                        <div class="caption-group">
                        </div>
                    </li>
                    <li><img src="/res/site/img/banner-promocao-esteira.jpg" alt="Slide">
                        <div class="caption-group">
                            
                        </div>
                    </li>
                    <li><img src="/res/site/img/banner-condominio.jpg" alt="Slide">
                        <div class="caption-group">
                        </div>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            <img src="/res/site/img/Sky.png" width="270px" height="120px"  alt="">
                            <img src="/res/site/img/Vivo.png" width="270px" height="120px" alt="">
                            <img src="/res/site/img/Mitsubishi_Home.png" width="270px" height="120px" alt="">
                            <img src="/res/site/img/Suzuki.png" width="270px" height="120px" alt="">                 
                        </div>
                    </div>
                </div>
            </div>
